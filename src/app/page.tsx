        ...
        <div id="features" className="grid md:grid-cols-3 gap-8 mb-16">
          <div id="feature-1" className="group relative overflow-hidden bg-blue-400 p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border-2 border-blue-500">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">AI-Powered Clues</h3>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold mb-2">Complete Adventures</h4>
              <p className="text-sm text-gray-600">Finish hunts to earn badges and become a master explorer</p>
            </div>
          </div>
        </div>
      </div>
