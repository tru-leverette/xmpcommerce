...
export default function PirateMapLoader({ onComplete, duration = 10000 }: PirateMapLoaderProps) {
  ...
  useEffect(() => {
    console.log('PirateMapLoader started with duration:', duration)
    ...
    // Show treasure effect at 80% completion
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-b from-amber-100 via-yellow-50 to-amber-200 overflow-hidden">
      ...
      <div className="relative h-full w-full p-8">
        ...
        {/* Map Grid */}
        <div className="relative w-full h-3/4 mx-auto max-w-4xl">
          
          {/* Compass Rose - Top Right */}
          <div className="absolute top-4 right-4 w-24 h-24 text-amber-800">
            <div className="relative w-full h-full border-4 border-amber-800 rounded-full bg-yellow-100 shadow-lg">
              <div className="absolute inset-2 border border-amber-600 rounded-full flex items-center justify-center">
          ...
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 800 600">
            {/* Island Shape */}
            <path
              d="M150 300 Q200 150 350 200 Q500 180 650 250 Q700 350 600 450 Q400 500 200 450 Q100 400 150 300 Z"
              fill="#8FBC8F"
              stroke="#654321"
              strokeWidth="3"
